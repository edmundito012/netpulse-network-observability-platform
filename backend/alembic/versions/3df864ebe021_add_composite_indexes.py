...
def upgrade() -> None:
    ...
    op.create_index(
        "ix_alerts_device_id_status", "alerts", ["device_id", "status"], unique=False
    )
    ...
    op.create_index(
        "ix_device_events_event_type", "device_events", ["event_type"], unique=False
    )
    op.create_index(
        "ix_device_metrics_device_id_checked_at",
        "device_metrics",
