...
@patch("app.services.device_service.PacketLossBurstIncidentService.evaluate")
@patch(
    "app.services.device_service.FlappingAlertService.create_flapping_alert_if_needed"
)
@patch(
...
@patch("app.services.device_service.AlertService.create_packet_loss_alert_if_needed")
@patch("app.services.device_service.JitterAlertService.evaluate")
@patch("app.services.device_service.DeviceMetricRepository.create")
@patch("app.services.device_service.MonitoringService.ping_device")
@patch("app.services.device_service.DeviceRepository.get_by_id")
def test_ping_evaluates_burst_after_metric_persistence(
    ...
    assert create_metric_mock.call_args_list and burst_incident_mock.call_args_list
