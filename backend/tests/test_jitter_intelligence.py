...
def test_stable_jitter():
    ...
    result = JitterIntelligenceService.analyze([4, 5, 6, 5, 4])
...
def test_degraded_jitter():
    ...
    result = JitterIntelligenceService.analyze([5, 10, 15, 12, 16])
...
def test_jitter_spike_detection():
    ...
    result = JitterIntelligenceService.analyze([5, 6, 7, 5, 50])
...
def test_jitter_degradation_trend():
    ...
    result = JitterIntelligenceService.analyze([5, 10, 15, 20, 25])
