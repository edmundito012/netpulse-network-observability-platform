...
class PredictiveAlertService:
    ...
    def detect_latency_trend(
        ...
        return PredictiveAlertService.is_increasing(latencies)
    ...
    def detect_packet_loss_trend(
        ...
        packet_loss = [metric.packet_loss_percent or 0 for metric in metrics]

        return PredictiveAlertService.is_increasing(packet_loss)
    ...
    def detect_jitter_trend(
        ...
        jitters = [metric.jitter_ms or 0 for metric in metrics]

        return PredictiveAlertService.is_increasing(jitters)
