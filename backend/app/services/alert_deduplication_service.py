...
class AlertDeduplicationService:
    ...
    def create_or_update(
        ...
        *,
        ...
        effective_key = deduplication_key or cls.build_deduplication_key(
            device_id=device_id,
            alert_type=alert_type,
        )

        active_alert = AlertRepository.get_active_by_deduplication_key(
            db=db,
            device_id=device_id,
        ...
        try:
            ...
            concurrent_alert = AlertRepository.get_active_by_deduplication_key(
                db=db,
                device_id=device_id,
                deduplication_key=effective_key,
            )
    ...
    def build_deduplication_key(
        *,
        ...
        return f"device:{device_id}:{alert_type.value.lower()}"
    ...
    def _register_duplicate(
        ...
        *,
        ...
        severity_escalated = AlertRepository.is_more_severe(
            new_severity=severity,
            current_severity=alert.severity,
        )

        updated_alert = AlertRepository.register_occurrence(
            db=db,
            alert=alert,
            severity=severity,
            message=message,
