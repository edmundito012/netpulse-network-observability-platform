...
class IncidentTimelineActorError(IncidentTimelineError):
    """Raised when timeline actor information is invalid."""


class IncidentTimelineEventNotFoundError(IncidentTimelineError):
    ...
    def __init__(
        ...
        super().__init__(f"Incident timeline event {event_id} was not found")
